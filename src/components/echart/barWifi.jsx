...
class PageComponent extends Component {
  ...
  initLines() {
    ...
    param.serrydata.map((item, index) => {
      ...
      tempObj.barWidth = item.barWidth === undefined ? 12 : item.barWidth;// x轴柱状的宽度
      tempObj.label = {
        normal: {
          show: true,
          color: '#BABDC0',
    ...
    const option = {
      ...
      legend: param.legend,
      color: ['#0CDAF2','#EE973F', '#53FED9', '#60B1CC', '#CFA448', '#6ED6C2', '#6C85BD', '#BAC3D2', '#F45C47'],
      tooltip: {
        trigger: 'axis',
        show:false
      },
      grid: {
        left: '4%',
        right: '8%',
        bottom: param.gridBottom !== undefined ? param.gridBottom : '8%',
        top: param.gridTop !== undefined ? param.gridTop : '10%',
        containLabel: true,
        borderWidth: 0,
        borderColor: '#666666'
      },
      xAxis: param.xAxis=== undefined ?[{
