  ...
  render() {
    ...
    return (
      <div className="threePiePage" style={{ height: '100%' }}>
        <div className="pieWrap1">
          <div style={{
            display: 'inline-block', width: '33%', height: '65%', paddingTop: '20px', textAlign: 'center', verticalAlign: 'middle'
          }}
          >
          ...
          {/*  className="pieTxt" */}
          {/*  style={{ */}
          {/*    display: 'inline-block', width: '50%', verticalAlign: 'middle' */}
          {/*  }} */}
          {/* > */}
          {/*  <div>亮灯率</div> */}
          {/*  <div>亮灯数：{standby}</div> */}
        ...
        <div className="pieWrap2">
          <div style={{
            display: 'inline-block', width: '33%', height: '65%', verticalAlign: 'middle'
          }}
          >
          ...
          {/*  className="pieTxt" */}
          {/*  style={{ */}
          {/*    display: 'inline-block', width: '50%', height: '100%', verticalAlign: 'middle' */}
          {/*  }} */}
          {/* > */}
          {/*  <div>在线率</div> */}
          {/*  <div>在线设备：{onlinenum}</div> */}
          {/*  <div>设备总数：{devnum}</div> */}
          {/* </div> */}
        </div>
        <div className="pieWrap3">
          <div style={{
            display: 'inline-block', width: '33%', height: '65%', verticalAlign: 'middle'
          }}
          >
