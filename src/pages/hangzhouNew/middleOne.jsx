...
class PageComponent extends Component {
  ...
  render() {
    ...
    return (
      <div className="middleOnePage">

        <div className="comTit" style={{ padding: '0 20px',margin:'5px 0 10px 15px' }}>
          {/* <BarsOutlined /> */}
          项目设备总览
        </div>
        <div className="carouselWrap">
          ...
          summaryData.length ? summaryData.map((item, index) => {
            if (index <= 2) {
              return (
                <div className="listOne" key={item?.devtpId} style={{ paddingTop: '13px' }}>
                  <div className="tit">{item?.devtpNm}</div>
                  <div className="num" style={{ marginTop: '10px', lineHeight: '26px' }}><span>{item?.devNum}</span>个</div>
                </div>
              );
            }
            if (item !== null) {
              return (
                <div className="listTwo" key={item?.devtpId}>
                  <div className="num"><span>{item?.devNum}</span></div>
                  <div className="tit" style={{ overflow: 'hidden', textOverflow: 'ellipsis' }}>{item?.devtpNm}</div>
                </div>
              );
            }
          }) : ''
          ...
          {/*  <div className="tit">灯杆总数</div> */}
          {/*  <div className="num"><span>20</span>个</div> */}
          {/* </div> */}

          {/* <div className="listOne"> */}
          {/*  <div className="tit">灯头总数</div> */}
          {/*  <div className="num"><span>20</span>个</div> */}
          {/* </div> */}

          {/* <div className="listOne" > */}
          {/*  <div className="tit">挑臂总数</div> */}
          {/*  <div className="num"><span>20</span>个</div> */}
          {/* </div> */}

          {/* <div className="listTwo"> */}
          {/*  <div className="num"><span>20</span></div> */}
          {/*  <div className="tit">环境气象</div> */}
          {/* </div> */}
          {/* <div className="listTwo"> */}
          {/*  <div className="num"><span>20</span></div> */}
          ...
          {/* <div className="listTwo"> */}
          {/*  <div className="num"><span>20</span></div> */}
          {/*  <div className="tit">IP广播</div> */}
          {/* </div> */}
          {/* <div className="listTwo" > */}
          {/*  <div className="num"><span>20</span></div> */}
          {/*  <div className="tit">一键报警</div> */}
          {/* </div> */}
          ...
          {/* <div className="listTwo"> */}
          {/*  <div className="num"><span>20</span></div> */}
          {/*  <div className="tit">信息屏</div> */}
          {/* </div> */}
          {/* <div className="listTwo"> */}
          {/*  <div className="num"><span>20</span></div> */}
          {/*  <div className="tit">USB充电</div> */}
          {/* </div> */}
          {/* <div className="listTwo" > */}
          {/*  <div className="num"><span>20</span></div> */}
          {/*  <div className="tit">汽车充电</div> */}
          {/* </div> */}
