...
import modalConfigEnv from './deviceModal/modalConfigEnviroment';
...
class PageComponent extends Component {
  ...
  renderMarkerLayout(extData) {
    ...
    if (extData.position.index === 1) {
      return (
        <div>
          <div style={{ color: '#fff', marginLeft: '-33px', minWidth: '80px' }}>
            {/*{extData.position.devname}*/}
          </div>
          <span className="icon iconfont icon-a-lujing2206" style={{ color: '#22B3C4', fontSize: '24px' }} />
    ...
    return (
      <div>
        <div className="popDiv">
          <Markhover type='weather' lightdev={extData.position.deveui} lightdevname={extData.position.devname} />
        </div>
        <span className="icon iconfont icon-a-lujing2206" style={{ color: '#22B3C4', fontSize: '24px' }} />
        {/* <img src={ltIcon} style={{ width: '20px' }} /> */}
      </div>
