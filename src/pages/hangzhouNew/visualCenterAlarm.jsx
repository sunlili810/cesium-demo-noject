...
import modalConfigAlarm from './deviceModal/modalConfigAlarm';
    ...
    if (extData.position.index === 1) {
      return (
        <div>
          ...
          >
            {/*{extData.position.devname}报警*/}
          </div>
          <span className="icon iconfont icon-a-lujing2224" style={{ color: '#22B3C4', fontSize: '24px' }} />
  ...
  renderMarkerDefaultHover(extData) {
    return (
      <div>
        ...
        >
          <Markhover type='alarm' lightdev={extData.position.deveui} lightdevname={extData.position.devname} />
        </div>
        <span className="icon iconfont icon-a-lujing2224" style={{ color: '#22B3C4', fontSize: '24px' }} />
        {/* <img src={ltIcon} style={{ width: '20px' }} /> */}
      </div>
    ...
    return (
      <Layout name="visualCenter">
        ...
        >
          ...
          <div className="mapDiv" style={{ display: size === '3d' ? 'block' : 'none', height: '100%' }}>
            {
              size === '3d' ? (
                <Map
                  center={mapCenter}
