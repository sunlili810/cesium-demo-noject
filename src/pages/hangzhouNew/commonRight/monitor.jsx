  ...
  componentWillUnmount() {
   ...
   fetchPie(deveui) {
     ...
     const param = {
       ...
       url: '/project/portal/projCustAttrWithType',
       method: 'get',
       data: {
         restype: 'rs_video_camera'
       },
         ...
         >
           <div className="topR" style={{ position: 'relative', height: '18%' }}>
             ...
             <div className="tit" style={{ fontWeight: '600', margin: '5px 0 15px 0' }}>
               <span className="icon iconfont icon-a-zu1821" style={{marginRight:'5px',fontWeight:'500'}} />
               监控设备概览
             </div>
             ...
             >
               <div><span className="icon iconfont icon-a-lujing2187" style={{ color: '#22B3C4', fontSize: '30px' }} /></div>
             ...
             >
               <div><span className="icon iconfont icon-a-lujing2187" style={{ color: '#29DC35', fontSize: '30px' }} /></div>
             ...
             >
               <div><span className="icon iconfont icon-a-lujing2187" style={{ color: '#B8B8B8', fontSize: '30px' }} /></div>
           ...
           <div className="energyDiv" style={{ position: 'relative', height: '32%', marginBottom: '5px' }}>
             ...
             <div className="tit titToday" style={{ fontWeight: '600', margin: '5px 0 15px 0' }}>
               <span className="icon iconfont icon-a-lujing2187" style={{marginRight:'5px',fontWeight:'500'}} />
               设备类型统计
             </div>
                 ...
                 alarmData.length ? alarmData.map((item, index) => (
                   <div className="listOne" key={index}>
                     <div className="time">
                       ...
                       <span className="status" style={{ color: item.confirmstate === 2 || item.confirmstate === 3 || item.confirmstate === 4 ? '#7E7E7E' : '#D95A5A' }}>{item.confirmstate === 0 ? '未确认' : item.confirmstate === 1 ? '告警' : item.confirmstate === 2 ? '误报' : item.confirmstate === 3 ? '已恢复' : item.confirmstate === 4 ? '其它' : ''}</span></div>
