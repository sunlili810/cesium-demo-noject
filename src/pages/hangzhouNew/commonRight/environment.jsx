...
class PageComponent extends Component {
  ...
  fetchSummary(deveui) {
    ...
    const param = {
      ...
      method: 'get',
      data: {
        fm_curalarm_devtype: 'claa_lamppost_weather',
  ...
  fetchPie(deveui) {
    ...
    const param = {
      loadingFlag: false,
      url: '/lamp/light/weather/alarm/count',
      method: 'get',
      data: {
        restype: 'claa_lamppost_weather'
      },
      successFn(data) {
        ...
        that.setState({
          ...
          //   {
          //     name: 'PM2.5',
          //     value: data.appdata.pm25
          //   },
          //   {
          //     name: 'PM10',
          //     value: data.appdata.pm10
          //   },
          //   {
          //     name: '温度',
          //     value: data.appdata.wd
          //   },
          //   {
          //     name: '湿度',
          //     value: data.appdata.sd
          //   },
          //   {
          //     name: '雨量',
          //     value: data.appdata.yl
          //   },
          //   {
          //     name: '光照',
          //     value: data.appdata.zfs
          //   },
          //   {
          //     name: '气压',
          //     value: data.appdata.qy
          //   },
          //   {
          //     name: '风速',
          //     value: data.appdata.fs
          //   },
          //   {
          //     name: '噪声',
          //     value: data.appdata.zs
          //   }
          // ]
        });
      }
        ...
        >
          <div className="topR" style={{ position: 'relative', height: '18%' }}>
            ...
            <div className="tit" style={{ fontWeight: '600', margin: '0px 0 15px 0' }}>
              <span className="icon iconfont icon-a-lujing2150" style={{ marginRight: '5px', fontWeight: '500' }} />
              气象设备概览
            </div>
            ...
            >
              <div><span className="icon iconfont icon-a-lujing2206" style={{ color: '#22B3C4', fontSize: '30px' }} /></div>
            ...
            >
              <div><span className="icon iconfont icon-a-lujing2206" style={{ color: '#29DC35', fontSize: '30px' }} /></div>
            ...
            >
              <div><span className="icon iconfont icon-a-lujing2206" style={{ color: '#B8B8B8', fontSize: '30px' }} /></div>
          ...
          <div className="energyDiv" style={{ position: 'relative', height: '32%', marginBottom: '5px' }}>
            ...
            <div className="pieWrap1" style={{ height: '86%' }}>
              <div style={{
                display: 'inline-block', width: '100%', height: '100%', paddingTop: '10px', textAlign: 'center', verticalAlign: 'middle'
              }}
              >
          ...
          <div className="bottomR" style={{ position: 'relative', height: '45%' }}>
            ...
            <div className="tit" style={{ fontWeight: '600', margin: '5px 0 15px 0' }}>
            ...
            <div className="alamList" style={{ height: '84%' }}>
              {
                alarmData.length ? alarmData.map(item => (
                  <div className="listOne" key={item.deveui}>
                    <div className="time">
                      <span className="tipColor" style={{ background: item.confirmstate === 2 || item.confirmstate === 3 || item.confirmstate === 4 ? '#7E7E7E' : '#D95A5A' }} />{item.alarmtime}
                      <span className="status" style={{ color: item.confirmstate === 2 || item.confirmstate === 3 || item.confirmstate === 4 ? '#7E7E7E' : '#D95A5A' }}>
