...
import modalConfigVideo from './deviceModal/modalConfigVideo';
...
class PageComponent extends Component {
    ...
    if (extData.position.index === 1) {
      return (
        <div>
          ...
          >
            {/*{extData.position.devname}摄像头*/}
          </div>
          {/* <span className="icon iconfont icon-a-lujing2187" style={{ color: '#FA83E0', fontSize: '24px' }} /> */}
          <span className="icon iconfont icon-a-lujing2187" style={{ color: '#22B3C4', fontSize: '24px' }} />
        </div>
      );
    }
    return (
  ...
  renderMarkerDefaultHover(extData) {
    return (
      <div>
        ...
        >
          <Markhover type='video' lightdev={extData.position.deveui} lightdevname={extData.position.devname} />
        </div>
        <span className="icon iconfont icon-a-lujing2187" style={{ color: '#22B3C4', fontSize: '24px' }} />
        {/* <img src={ltIcon} style={{ width: '20px' }} /> */}
      </div>
  ...
  render() {
    const { treeData,treeDataArry, mapCenter, size } = this.state;
