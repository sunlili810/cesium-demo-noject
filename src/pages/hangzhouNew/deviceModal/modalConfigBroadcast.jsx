...
class modalComponent extends Component {
  ...
  render() {
    ...
    const tempData = baseData?.broadcast;
    ...
    return (
      <div className="deviceModal" style={{ position: 'relative' }}>
        <div style={{
          fontSize: '16px', fontWeight: 'bold', color: '#fff', height: '35px', lineHeight: '35px', marginBottom: '15px'
        }}
        >设备概览
        </div>
        {/* <div className="leftM"> */}
            ...
            <div className="listonecont" style={{ color: '#fff' }}>
              ...
              <div style={{ lineHeight: '35px' }}>
                ...
                <span style={{ display: 'inline-block', width: '45%' }}>设备状态：
                  {tempData?.[0]?.eqstate === '1' || tempData?.[0]?.eqstate === 1 ? '在线' : tempData?.[0]?.eqstate === '2' || tempData?.[0]?.eqstate === 2 ? '离线' : ''}</span>
              </div>
              ...
              <div style={{ margin: '10px 0 0 0', fontSize: '16px' }}>电源控制</div>
              ...
              <div className="" style={{ margin: '10px 0 2px 0', fontSize: '16px' }}>音量控制
