...
import BroadcastTypeStatics from './broadcastTypeStatics';
       ...
       <div className="commonRightFloatPage">
         ...
         >
           <div className="topR">
             ...
             {/*<div className="tit titToday" style={{ fontWeight: '600', margin: '15px 0' }}>亮灯率</div>*/}

             {/*<div className="pieWrap1">*/}
             {/*  <div style={{*/}
             {/*    display: 'inline-block', width: '60%', height: '65%', paddingTop: '20px', textAlign: 'center', verticalAlign: 'middle'*/}
             {/*  }}*/}
             {/*  >*/}
             ...
             {/*    className="pieTxt"*/}
             {/*    style={{*/}
             {/*      display: 'inline-block', width: '40%', verticalAlign: 'middle'*/}
             {/*    }}*/}
             {/*  >*/}
             {/*    <div>亮灯率</div>*/}
             {/*    <div>亮灯数：97</div>*/}
             ...
             <div className="tit" style={{ fontWeight: '600', margin: '20px 0' }}>广播类型统计</div>

             <BroadcastTypeStatics />
